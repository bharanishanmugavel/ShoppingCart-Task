    ...
    return (
        <div className="col mb-5">
            <div className="card h-100 bg-secondary" >
                <div className="badge bg-primary text-white position-absolute" style={{ top: "0.5rem", right: "0.5rem" }}>{product.sale}</div>
                <img className="card-img-top" src={product.img}  alt="..." height="150px" />
